...
- The pending queues are reconciled against the jobs table after each cleaner cycle, as a safety net for out-of-band writes (e.g. deploy windows with 5.x writers still running).
